...
### What is a child device link?

It is the link or QR code that connects a child’s device to the child dashboard.

### What should I do if the child link expires?

Generate a fresh child link from the parent dashboard and open the new one on the child device.
...
### What are points or HP?

Points are the family score children earn or lose. HP is the spending balance shown for a child.

### What is the spending balance?

It is the amount a child can use right now for rewards.

### What is the saved balance?

It is points set aside for later.

### What are held or reserved points?
...
### What are Positive, Negative, and Other point actions?

Positive adds points, Negative removes points, and Other lets a parent enter a custom point action.
...
The request is rejected and the held points go back to the child’s spending balance.
...
Children can see points, rewards, My Day, School Bag, and their pet or dragon progress if it is shown on their dashboard.
...
### What does the pet or dragon mean?
...
Check **View pending requests**, refresh the page, and confirm the child sent the request from the correct child device.
