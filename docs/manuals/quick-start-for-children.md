...
1. Choose a reward.
2. Tap **Request**.
3. Wait until it says **pending**.
4. Ask your parent if you are unsure.

If allowance is on, the reward also shows the money value beside the points cost.
...
Have fun, earn points, and ask your parent if you need help.
