...
| Recognition configuration | Explicit support only | `V,S,C,E,D` School | `V,S,E` School | `V,S,E` School | — | — | — | `V` only if explicitly published to linked family | — |
| Recognition review/certificate | Explicit audited support only | `V,S,C,E,X,A` School | `V,S,C,E,X,A` School | `V,S,C,E,X,A` School | — | — | — | `V` shared item | — |
