...
def validate_runtime_configuration(settings: "Settings" | None = None) -> str:
    ...
    for name, value, minimum, maximum in (
        ...
        ("MESSAGING_NOTIFICATION_SCHEDULER_LEASE_SECONDS", config.MESSAGING_NOTIFICATION_SCHEDULER_LEASE_SECONDS, 30, 3600),
        ("MESSAGING_NOTIFICATION_RECHECK_SECONDS", config.MESSAGING_NOTIFICATION_RECHECK_SECONDS, 30, 86400),
    ...
    if config.MESSAGING_NOTIFICATION_RETRY_MAX_SECONDS < config.MESSAGING_NOTIFICATION_RETRY_BASE_SECONDS:
        _fail(
            "MESSAGING_NOTIFICATION_RETRY_MAX_SECONDS",
            "must be greater than or equal to MESSAGING_NOTIFICATION_RETRY_BASE_SECONDS",
        )
...
class Settings(BaseSettings):
    ...
    MESSAGING_NOTIFICATION_RECHECK_SECONDS: int = 300
    ...
    MESSAGING_PRODUCTION_WORKER_ENABLED: bool = False
    MESSAGING_PRODUCTION_WORKER_POLL_SECONDS: int = 15
    MESSAGING_PRODUCTION_JOB_LEASE_SECONDS: int = 300
